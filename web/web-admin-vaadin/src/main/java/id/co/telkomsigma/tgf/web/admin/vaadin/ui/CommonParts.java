...
public class CommonParts extends VerticalLayout implements View {
     ...
     *
     */
    private static final long serialVersionUID = -775435662207352364L;
    ...
    Panel notifications() {
        ...
        VerticalLayout content = new VerticalLayout() {
             ...
             *
             */
            private static final long serialVersionUID = -9097876951077498925L;
            ...
            TextField delay = new TextField();
            {
                ...
                title.setCaption("Title for the notification");
                ...
                description.setCaption("Description for the notification");
                description.addStyleName(ValoTheme.TEXTAREA_SMALL);
                description.addValueChangeListener(new HasValue.ValueChangeListener() {
                    @Override
    ...
    Panel windows() {
        ...
        VerticalLayout content = new VerticalLayout() {
...

            {
                ...
                hidden.addValueChangeListener(new HasValue.ValueChangeListener() {
                    @Override
                    public void valueChange(HasValue.ValueChangeEvent event) {
