...
public class MenuBars extends VerticalLayout implements View {
    ...
    static MenuBar getMenuBar() {
        ...
        final MenuItem file = menubar.addItem("File", null);
        final MenuItem newItem = file.addItem("New", null);
        ...
        final MenuItem edit = menubar.addItem("Edit", null);
        ...
        final MenuItem find = edit.addItem("Find/Replace", null);
        ...
        final MenuItem view = menubar.addItem("View", null);
    ...
    static MenuBar getMenuButton(String caption, boolean splitButton) {
        ...
        MenuItem dropdown = split.addItem(caption, null);
        if (splitButton) {
