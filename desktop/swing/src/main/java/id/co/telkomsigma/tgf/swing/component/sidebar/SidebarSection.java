...
public class SidebarSection extends JPanel {
	...
	public SidebarSection(SideBar owner, String text, JComponent component, Icon icon) {
	 ...
	 *
	 */
	public SidebarSection(SideBar owner, JComponent titleComponent, JComponent component, Icon icon) {
